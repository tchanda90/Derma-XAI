...
class Resnet50(pl.LightningModule):
    ...
    def val_dataloader(self):
        if False:# self.weighted_sampling:
            ...
            return DataLoader(self.val_set, batch_size=batch_size, shuffle=False, sampler=sampler, num_workers=1)
        else:
            return DataLoader(self.val_set, batch_size=batch_size, shuffle=False, num_workers=1)

    def test_dataloader(self):
        return DataLoader(self.test_set, batch_size=batch_size, shuffle=False, num_workers=1)
...
class Resnet34(pl.LightningModule):
    ...
    def train_dataloader(self):
        if self.weighted_sampling:
            ...
            weights = labels_weights[y]
            sampler = WeightedRandomSampler(weights, num_samples=len(weights))
            return DataLoader(self.train_set, batch_size=self.batch_size, shuffle=False, sampler=sampler, num_workers=4)
        else:
    ...
    def val_dataloader(self):
        if False:# self.weighted_sampling:
            ...
            weights = labels_weights[y]
            sampler = WeightedRandomSampler(weights, len(weights))
            return DataLoader(self.val_set, batch_size=batch_size, shuffle=False, sampler=sampler, num_workers=4)
        else:
            return DataLoader(self.val_set, batch_size=batch_size, shuffle=False, num_workers=4)

    def test_dataloader(self):
        return DataLoader(self.test_set, batch_size=batch_size, shuffle=False, num_workers=4)
...
class Resnet101(pl.LightningModule):
    ...
    def val_dataloader(self):
        if False:# self.weighted_sampling:
            ...
            weights = labels_weights[y]
            sampler = WeightedRandomSampler(weights, len(weights))
            return DataLoader(self.val_set, batch_size=batch_size, shuffle=False, sampler=sampler, num_workers=num_workers)
        else:
...
class Densenet121(pl.LightningModule):
    def __init__(self, hidden_size=64, learning_rate=2e-4, data_dir='./', train_data_dir='./', val_data_dir='./',
        ...
        densenet.classifier = torch.nn.Linear(densenet.classifier.in_features, 1)
...
class EfficientNetB3(pl.LightningModule):
    def __init__(self, hidden_size=64, learning_rate=2e-4, data_dir='./', train_data_dir='./', val_data_dir='./',
        ...
        efficientnet._fc = nn.Sequential(
            nn.Dropout(p=dropout),
            nn.Linear(in_features=efficientnet._fc.in_features, out_features=1)
        )
